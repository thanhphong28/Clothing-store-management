...
('HD011', 'HANG5', 350000, 4, 2050000, 0);
('HD011', 'HANG3', 350000, 3, 1050000, 0);
('HD012', 'HANG2', 350000, 1, 105000, 0);
('HD013', 'HANG1', 350000, 6, 305000, 0);
('HD014', 'HANG5', 350000, 3, 1050000, 0);
('HD015', 'HANG4', 350000, 5, 3050000, 0);
('HD016', 'HANG1', 350000, 3, 1050000, 0);
('HD017', 'HANG2', 350000, 3, 5050000, 0);
('HD018', 'HANG3', 350000, 1, 1050000, 0);
('HD019', 'HANG4', 350000, 4, 1050000, 0);
('HD020', 'HANG6', 350000, 3, 105000, 0);
...
('PN011', 'HANG3', 20000, 1, 20000);
('PN011', 'HANG1', 20000, 2, 40000);
('PN012', 'HANG2', 10000, 3, 30000);
('PN012', 'HANG3', 20000, 4, 80000);
('PN013', 'HANG4', 20000, 5, 100000);
('PN013', 'HANG5', 20000, 6, 120000);
...
('HD015', 'NV001', 'KH005', 'KM002', '2023-05-05', 1380000, 0, 1380000);
('HD016', 'NV002', 'KH002', 'KM001', '2023-03-04', 1380000, 0, 1380000);
('HD017', 'NV003', 'KH005', 'KM002', '2023-08-17', 1380000, 0, 1380000);
('HD018', 'NV004', 'KH001', 'KM003', '2023-06-25', 1380000, 0, 1380000);
('HD019', 'NV001', 'KH005', 'KM002', '2023-09-05', 1380000, 0, 1380000);
('HD020', 'NV002', 'KH003', 'KM005', '2023-10-16', 1380000, 0, 1380000);
...
('KH009', 'Nguyễn', 'Thanh Phong', '0618293756', '300 Âu Dương Lân Q8');
('KH009', 'Trần', 'Thiệu Huy', '0922238862', '828/6 Trần Hưng Đạo P7 Q5');
('KH009', 'Phạm', 'Tuấn Anh', '0937971799', '17/5/3 Lương Minh Nguyệt ');
('KH009', 'Trần', 'Tường Minh', '0123458769', '51 Ngô Quyền');
('KH009', 'Phú', 'Ngọc Diễm', '0888892233', '15 Nguyễn Trãi');
('KH009', 'Phạm', 'Tuấn Khang', '0908906565', '33 Nguyễn Tri Phương');
('KH009', 'Nguyễn', 'Ngọc Trâm', '0913995555', '44 Thành Thái');
('KH009', 'Bùi', 'Thanh Phước', '0933385767', '555 Đường 3/2');
('KH009', 'Nguyễn', 'Thanh Sang', '0708776762', '66 Cách Mạng Tháng 8');
('KH009', 'Phan', 'Tuấn Quốc', '0888888888', '77 Lý Thái Tổ');
('KH009', 'Nguyễn', 'Minh Cảnh', '0999999999', '88 Nguyễn Chí Thanh');
('KH009', 'Trần', 'Minh Dương', '0111111111', '99 Nguyễn Kim');
...
('NV001', 'Nguyễn', 'Thanh Phong', '123 An Dương Vương P7 Q5 TPHCM', 'Quản lý', 100000),
('NV002', 'Trần', 'Lương Thiệu Huy', '331 Lê Hồng Phong P2 Q10 TPHCM', 'Nhân viên', 150000),
('NV003', 'Nguyễn', 'Quý Hùng', '45/25 Phạm Hùng P9 Q8 TPHCM', 'Quản lý', 300000),
('NV004', 'Võ ', 'Trần Linh', '273 An Dương Vương P3 Q5 TPHCM', 'Nhân Viên', 15000),
('NV005', 'Nguyễn', 'Ngô Thế Anh', '253 Trần Hưng Đạo P3 Q5 TPHCM', 'Nhân Viên', 50000);
('NV006', 'Phú', 'Tuấn Anh', '51/20 Ngô Quyền P6 Q10 TPHCM', 'Nhân Viên', 50000);
('NV007', 'Lê', 'Minh Nguyệt', '203 Quốc lộ 50 P5 Q8 TPHCM', 'Nhân Viên', 50000);
-- --------------------------------------------------------
